...
from load_data import load_main_data, load_ipa, load_emotion, load_competitive, load_segments
...
with tab1:
    ...
    def _fix_mojibake(s):
        """Perbaiki kutip pintar (\u201c \u201d) yang ter-decode salah dari xlsx (cp1252 dibaca sebagai UTF-8)."""
